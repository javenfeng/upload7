#!/usr/bin/env python
# -*- coding:utf-8 -*-
""" uploader helper for kindleear7
...
KE_DIR = 'kindleear7'
KE_MASTER_DIR = 'kindleear7-master'
...
def Main():
    #Searching for kindleear7 folder
    ...
    if not dirs:
        print("Cant found folder 'kindleear7'! Please download it from github firstly.")
        return 1
    ...
    if not slapp:
        print("Not exist 'app.yaml' or it's invalid, please download kindleear7 again.")
        return 1
    ...
    if not slcfg:
        print("Not exist 'config.py' or it's invalid, please download kindleear7 again.")
        return 1
    ...
    if mt:
        ...
        print('app.yaml seems invalid, please download kindleear7 again.')
        return 1
    ...
    if slwork:
        ...
        if mt:
            ...
            print('module-work.yaml seems invalid, please download kindleear7 again.')
            return 1
